...
# {"name"=>"Ansible-Sample-TDD", "hosts"=>["192.168.56.103","192.168.56.103"], "user"=>"root", "roles"=>["nginx", "mariadb"]}
# {"name"=>"Ansible-Sample-TDD", "hosts"=>[{"name" => "192.168.56.103:22","uri"=>"192.168.56.103","port"=>22, "private_key"=> "~/.ssh/id_rsa"}], "user"=>"root", "roles"=>["nginx", "mariadb"]}
